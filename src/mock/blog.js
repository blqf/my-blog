 ...
 * 模拟获取博客数据的响应
 */
Mock.mock(/^\/api\/blog(\?.{0,}){0,1}$/, 'get', function (options) {
    const query = qs.parse(options.url);
    const data = {
        'total|100-300': 0,
        [`rows|${query.limit || 10}`]: [{
            'id': '@guid',
            title: '@ctitle(3, 50)',// 标题
            description: '@cparagraph(1,10)',// 描述
            category: { // 博客所属分类
                'id|0-10': 0,
                name: "分类@id",
            },
            "scanNumber|0-3000": 0,// 此博客被浏览的次数
...
Mock.mock("/api/comment", "post", {
    ...
    data: {
        ...
        "avatar|1": [
            ...
            'https://ae01.alicdn.com/kf/H6176ad0b50424011aa3ecd4fea16694fZ.jpg',
            'https://ae01.alicdn.com/kf/Hdcdb50046da943ff947555e453b16b76X.jpg',
            'https://ae01.alicdn.com/kf/H4cd9945926d144a68f11d28f6544534e8.jpg',
            'https://ae01.alicdn.com/kf/H8254a69fe2484f289d73385b4c253203X.jpg',
            'https://ae01.alicdn.com/kf/Haf82117a9d6a457ea32db037635a9158q.jpg',
            'https://ae01.alicdn.com/kf/H836376a811aa4007a332f1be1c1da9d0S.jpg',
        ],
    },
});
